...
export default function HelpPage({ onNavigateToPortal }: HelpPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-slate-100 flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden font-sans select-none">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_800px_at_center,rgba(6,182,212,0.05),transparent)] pointer-events-none" />
      
      {/* Main Glassmorphism Card Container */}
      <div className="max-w-4xl w-full bg-slate-900/80 backdrop-blur-xl border border-cyan-500/30 rounded-3xl p-6 md:p-10 shadow-[0_0_30px_rgba(6,182,212,0.1)] relative z-10 my-auto">
        ...
        {/* Title Header */}
        <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-6 tracking-tight">
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Left Card - German */}
            <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-5 hover:border-cyan-500/40 transition-all">
        ...
        {/* Section 2: Core Capabilities (Grid of 4 Cards) */}
        <section className="mb-10">
          <div className="flex items-center gap-2 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-5 hover:border-cyan-500/40 transition-all flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 rounded-xl bg-cyan-950/80 border border-cyan-500/30 text-cyan-400">
                    <Mic className="w-5 h-5" />
                  </div>
                  <h3 className="font-bold text-slate-100 text-base">Ambient Voice Dictation</h3>
                </div>
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-5 hover:border-cyan-500/40 transition-all flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-bold text-slate-100 text-base">AI Gutachten Engine</h3>
                </div>
                <p className="text-xs text-slate-300 leading-relaxed mt-2 font-sans">
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-5 hover:border-cyan-500/40 transition-all flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-bold text-slate-100 text-base">Practice CFO (Revenue Finder)</h3>
                </div>
                <p className="text-xs text-slate-300 leading-relaxed mt-2 font-sans">
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-5 hover:border-cyan-500/40 transition-all flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-bold text-slate-100 text-base">Emergency Triage Radar</h3>
                </div>
                <p className="text-xs text-slate-300 leading-relaxed mt-2 font-sans">
