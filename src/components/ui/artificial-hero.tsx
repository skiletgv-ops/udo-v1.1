...
export const Component = ({ showOverlay = true }: ComponentProps) => {
  ...
  return (
    <div ref={containerRef} style={{ width: "100%", height: "100%", background: "#000" }}>
      {/* Navigation - Only visible if showOverlay is true */}
      {showOverlay && (
        <nav
          style={{
            position: "fixed",
      ...
      {/* Large text - Only visible if showOverlay is true */}
      {showOverlay && (
        <div
          style={{
            position: "fixed",
      ...
      {/* Left side text - Only visible if showOverlay is true */}
      {showOverlay && (
        <div
          style={{
            position: "fixed",
      ...
      {/* Right side text - Only visible if showOverlay is true */}
      {showOverlay && (
        <div
          style={{
            position: "fixed",
      ...
      {/* Bottom text - Only visible if showOverlay is true */}
      {showOverlay && (
        <div
          style={{
            position: "fixed",
