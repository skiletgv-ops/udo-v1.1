    ...
    try {
      ...
      program = new Program(glContext as any, {
        ...
        uniforms: {
          ...
          iResolution: {
            value: new Vec3(
              (glContext.canvas as HTMLCanvasElement).width,
              (glContext.canvas as HTMLCanvasElement).height,
              (glContext.canvas as HTMLCanvasElement).width / (glContext.canvas as HTMLCanvasElement).height
            ),
          },
          hue: { value: hue },
          hover: { value: 0 },
